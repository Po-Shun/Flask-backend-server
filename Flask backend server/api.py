...
def get_all():
    ...
    for i in a:
        ...
        if(flag and flag2):
            ...
            d['max'] = i[6]
            d['comment'] = i[7]
            d['url'] = "https://7097-140-113-124-40.ngrok.io/detail/"+str(i[0])
            all.append(d)
    j = json.dumps(all)
    return j
...
def get_Detail():
    ...
    connection = sqlite3.connect('test.db')
    cursor = connection.cursor()
    query_detail = get_All_command + "where f.id = " + str(id) + ";"
    ...
    for i in a :
        ...
        d['max'] = i[6]
        d['comment'] = i[7]
        d['url'] = "https://7097-140-113-124-40.ngrok.io/detail/"+str(id)
        all.append(d)
    j = json.dumps(all)
    return j
...
def add_Form():
    ...
    url = "https://d54f-140-113-124-40.ngrok.io/detail/"
    connection = sqlite3.connect('test.db')
    cursor = connection.cursor()
    ...
    get_id = get_id[0][0]
    return_url = "https://d54f-140-113-124-40.ngrok.io/detail/" + str(get_id)
    connection.commit()
    res = {}
    if(get_id):
        res['url'] = return_url
